...
public class SecurityConfiguration {
    ...
    public String WHITELIST_URL[] = {"/api/v1/auth/**","/api/v1/courses/**"};
//    
    @Bean
...
//                .requestMatchers("	/**")
                ...
                .addFilterBefore(jwtAuthFilter, UsernamePasswordAuthenticationFilter.class); // 2. Adding a jwtAuthFilter
                                                                                             // before
